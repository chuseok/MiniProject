 ...
 * Generated at: 2021-01-04 04:40:07 UTC
...
public final class resPro_jsp extends org.apache.jasper.runtime.HttpJspBase
...
while(rs.next()){
	custid=rs.getInt(1);
      ...
      out.write('\n');
      if (true) {
        _jspx_page_context.forward("resResult.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("custId", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf(custid), request.getCharacterEncoding()));
        return;
      }
      out.write("\r\n");
      out.write("\r\n");
